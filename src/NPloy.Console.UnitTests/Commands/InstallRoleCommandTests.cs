...
namespace NPloy.Console.UnitTests.Commands
{
    ...
    public class InstallRoleCommandTests
    {
        ...
        public void Run_ShouldSetParametersOnInstallPackageCommand()
        {
            ...
            _command.InstallDirectory = @"c:\install";
            ...
            _installPackageCommandMock.VerifySet(c => c.WorkingDirectory = @"c:\install", Times.Once());
            ...
            _installPackageCommandMock.VerifySet(c => c.IncludePrerelease = true, Times.Once());
        }
    }
